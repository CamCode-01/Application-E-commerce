...
class SliderController extends Controller
{
    ...
    public function editer_slider($id){
        ...
        return view('admin.editer_slider')->with('slider',$slider);
    }
...
return redirect('/sliders')->with('statut', 'Le slider a été modifié avec succès!');
    ...
    public function supprimerslider($id){
        ...
        if($slider ->slider_image != 'noimage.jpg'){
         ...
         $slider->delete();
         return redirect('/sliders')->with('statut', 'Le slider a été supprimé avec succès!');
    ...
    public function desactiver_slider($id){
        ...
        return redirect('/sliders')->with('statut', 'Le slider  a été désactiver avec succès!');
    ...
    public function activer_slider($id){
        ...
        return redirect('/sliders')->with('statut', 'Le slider  a été activer avec succès!');
